    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(default='no avatar', upload_to='user/', verbose_name='фото')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mail', models.EmailField(max_length=150, unique=True, verbose_name='Почта')),
                ('comment', models.TextField(blank=True, null=True, verbose_name='комментарий')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('published_time', models.DateTimeField(default=datetime.datetime(2023, 9, 20, 10, 56, 18, 55635), verbose_name='время')),
                ('period', models.CharField(choices=[('hourly', 'Раз в час'), ('daily', 'Ежедневная'), ('weekly', 'Раз в неделю')], max_length=20, verbose_name='период')),
                ('status', models.CharField(choices=[('started', 'Запущена'), ('created', 'Создана'), ('done', 'Завершена')], max_length=20, verbose_name='статус')),
                ('subject', models.CharField(default='Без темы', max_length=200, verbose_name='тема письма')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mailings', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='user.mailing')),
            ],
        ),
    ]
